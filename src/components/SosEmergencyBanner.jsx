...
export const SosEmergencyBanner = ({ onSelectEvent }) => {
  ...
  return (
    <aside 
      ...
      className="relative z-40 bg-slate-950/95 backdrop-blur-2xl text-white shadow-2xl border-b border-rose-500/40 overflow-hidden page-enter"
    >
      {/* Luminous SOS Horizon Rim */}
      <div className="absolute top-0 left-0 right-0 h-[2px] bg-gradient-to-r from-amber-500 via-rose-500 to-amber-500 shadow-[0_0_15px_rgba(244,63,94,0.6)]" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3.5">
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-3 text-left">
          ...
          <div className="flex items-start sm:items-center gap-3">
            <div className="w-10 h-10 rounded-2xl bg-rose-500/20 backdrop-blur-md flex items-center justify-center shrink-0 border border-rose-500/40 shadow-[0_0_15px_rgba(244,63,94,0.3)] animate-pulse">
